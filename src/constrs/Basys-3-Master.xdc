...
set_property -dict { PACKAGE_PIN T1    IOSTANDARD LVCMOS33 } [get_ports {sw_sub[0]}]
set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports {sw_sub[1]}]
...
set_property -dict { PACKAGE_PIN W3    IOSTANDARD LVCMOS33 } [get_ports {watch_state_led[0]}]
set_property -dict { PACKAGE_PIN U3    IOSTANDARD LVCMOS33 } [get_ports {watch_state_led[1]}]
set_property -dict { PACKAGE_PIN P3    IOSTANDARD LVCMOS33 } [get_ports {watch_state_led[2]}]
#set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports {led[13]}]
set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports {sw_sub_led[0]}]
set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports {sw_sub_led[1]}]
...
#set_property -dict { PACKAGE_PIN K3   IOSTANDARD LVCMOS33 } [get_ports dht11_io];#Sch name = XA1_N
